 ...
 * @param autoUpdateConsumption    When true, [consumptionLper100km] is automatically refreshed
 *                                 from the refuel ledger (H4) after each refuel is saved.
 *                                 When false, the manually-entered value is kept.
 */
data class Bike(
    val id: String,
    val name: String,
